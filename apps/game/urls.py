...
urlpatterns = [
    ...
    url(r'^clubs/$', views.club_list_all, name='club_list_all'),
    url(r'^clubs/new/$', views.club_add, name='club_add'),
    url(r'^clubs/(?P<club_slug>[\w-]+)/edit/', views.club_edit, name='club_edit'),
    url(r'^clubs/(?P<club_slug>[\w-]+)/', views.club_detail, name='club_detail'),
]
