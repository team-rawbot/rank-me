...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'game_game', 'winner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['game.Team']))

        # Changing field 'Game.loser'
        db.alter_column(u'game_game', 'loser_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['game.Team']))

    def backwards(self, orm):
        # Adding model 'Rank'
        db.create_table(u'game_rank', (
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='rank', unique=True, to=orm['auth.User'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        # Changing field 'Game.winner'
        db.alter_column(u'game_game', 'winner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Game.loser'
        db.alter_column(u'game_game', 'loser_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
