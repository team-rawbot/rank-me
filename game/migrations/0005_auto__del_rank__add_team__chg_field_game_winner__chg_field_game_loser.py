...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'game_rank', (
            ('user',
                self.gf('django.db.models.fields.related.ForeignKey')(related_name='rank',
                    unique=True, to=orm[user_orm_label])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        # Changing field 'Game.winner'
        db.alter_column(u'game_game', 'winner_id',
                self.gf('django.db.models.fields.related.ForeignKey')(to=orm[user_orm_label]))

        # Changing field 'Game.loser'
        db.alter_column(u'game_game', 'loser_id',
                self.gf('django.db.models.fields.related.ForeignKey')(to=orm[user_orm_label]))
    ...
    models = {
        ...
        u'game.team': {
            ...
            'users': ('django.db.models.fields.related.ManyToManyField', [],
                {'to': u"orm[user_orm_label]", 'symmetrical': 'False'})
        }
    }
