...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Score', fields ['competition', 'team']
        db.create_unique(u'game_score', ['competition_id', 'team_id'])

        # Adding unique constraint on 'HistoricalScore', fields ['team', 'game', 'competition']
        db.create_unique(u'game_historicalscore', ['team_id', 'game_id', 'competition_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'HistoricalScore', fields ['team', 'game', 'competition']
        db.delete_unique(u'game_historicalscore', ['team_id', 'game_id', 'competition_id'])

        # Removing unique constraint on 'Score', fields ['competition', 'team']
        db.delete_unique(u'game_score', ['competition_id', 'team_id'])
