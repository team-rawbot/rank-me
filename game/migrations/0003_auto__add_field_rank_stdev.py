...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Rank.stdev'
        db.add_column(u'game_rank', 'stdev',
                      self.gf('django.db.models.fields.FloatField')(default=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Rank.stdev'
        db.delete_column(u'game_rank', 'stdev')
    ...
    models = {
        ...
        u'game.game': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 22, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'game.rank': {
            ...
            'stdev': ('django.db.models.fields.FloatField', [], {}),
