...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HistoricalScore.stdev'
        db.add_column(u'game_historicalscore', 'stdev',
                      self.gf('django.db.models.fields.FloatField')(default=8.333),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HistoricalScore.stdev'
        db.delete_column(u'game_historicalscore', 'stdev')
