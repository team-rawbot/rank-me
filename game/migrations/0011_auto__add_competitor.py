...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'game_competitor', (
        ...
        db.send_create_signal(u'game', ['Competitor'])


    def backwards(self, orm):
        # Deleting model 'Competitor'
        db.delete_table(u'game_competitor')
    ...
    models = {
        ...
        u'game.competition': {
            ...
            'competitors': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['auth.User']", 'through': u"orm['game.Competitor']", 'symmetrical': 'False'}),
