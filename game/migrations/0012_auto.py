...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field players on 'Competition'
        m2m_table_name = db.shorten_name(u'game_competition_players')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('competition', models.ForeignKey(orm[u'game.competition'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['competition_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field players on 'Competition'
        db.delete_table(db.shorten_name(u'game_competition_players'))
