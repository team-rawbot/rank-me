...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Team.score'
        db.alter_column(u'game_team', 'score', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'Team.score'
        db.alter_column(u'game_team', 'score', self.gf('django.db.models.fields.IntegerField')())
