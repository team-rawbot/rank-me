...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'game_competition', 'name',
                      self.gf('django.db.models.fields.CharField')(default='Default competition', max_length=255),
                      keep_default=False)

        # Adding field 'Competition.description'
        db.add_column(u'game_competition', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Competition.start_date'
        db.add_column(u'game_competition', 'start_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Competition.end_date'
        db.add_column(u'game_competition', 'end_date',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'game_competition', 'name')

        # Deleting field 'Competition.description'
        db.delete_column(u'game_competition', 'description')

        # Deleting field 'Competition.start_date'
        db.delete_column(u'game_competition', 'start_date')

        # Deleting field 'Competition.end_date'
        db.delete_column(u'game_competition', 'end_date')
