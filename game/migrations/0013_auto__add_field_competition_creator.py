...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Competition.creator'
        db.add_column(u'game_competition', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='my_competitions', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Competition.creator'
        db.delete_column(u'game_competition', 'creator_id')
    ...
    models = {
        ...
        u'game.competition': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'related_name': "'my_competitions'", 'to': u"orm['auth.User']"}),
